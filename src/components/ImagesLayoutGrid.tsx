...
const SkeletonOne = () => {
	return (
		<div>
			<p className='font-bold text-4xl text-white'>Kicking Hard</p>
			<p className='font-normal text-base text-white'>Muay Thai </p>
			<p className='font-normal text-base my-4 max-w-lg text-neutral-200'>Coach work</p>
		</div>
	)
}
...
const cards = [
	{
		id: 1,
		content: <SkeletonOne />,
		className: 'md:col-span-2 hover:scale-105 scale-100',
		thumbnail: '/6.jpg'
	},
	{
		id: 2,
		content: <SkeletonTwo />,
		className: 'col-span-1 hover:scale-105 scale-100',
		thumbnail: '/10.jpg'
	},
	{
		id: 3,
